package com.szjm.controller.lsh.lshuser;
...
public class LshUserController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("lsh/lshuser/lshuser_list");
	...
	public ModelAndView goEdit()throws Exception{
	 ...
	 /**去填写礼豆页面
		...
		public ModelAndView goAddIntegrationS()throws Exception{
			...
			pd = this.getPageData();
			pd = lshuserService.findById(pd);	//根据ID读取
			mv.setViewName("lsh/lshuser/addIntegration");
	...
	public ModelAndView goUserDetail()throws Exception{
		...
		mv.setViewName("lsh/lshuser/lshuser_detail");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView goOrderDetail(Page page)throws Exception{
		...
		mv.setViewName("lsh/order/order_list");
	...
	public ModelAndView integrationDetail(Page page)throws Exception{
		...
		mv.setViewName("lsh/integrationrecord/integrationrecord_list");
		mv.addObject("varList", orderDetail);
		mv.addObject("pd", pd);
		mv.addObject("QX",Jurisdiction.getHC());	//按钮权限
		return mv;
	 ...
	 /**导出到excel
		...
		public ModelAndView exportExcel() throws Exception{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var6", varOList.get(i).getString("SOLAR_BIRTHDAY")!=null?varOList.get(i).getString("SOLAR_BIRTHDAY").toString():"");	    //15
