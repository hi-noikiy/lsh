package com.szjm.controller.lsh.collection;
...
public class CollectionController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("lsh/collection/collection_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("lsh/collection/collection_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).get("COLLECTION_ID").toString());	//1
			...
			vpd.put("var10", varOList.get(i).get("COLLECTION_TYPE").toString());	//10
			varList.add(vpd);
		}
