package com.szjm.controller.lsh.expresscompany;
...
public class ExpressCompanyController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("lsh/expresscompany/expresscompany_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("lsh/expresscompany/expresscompany_edit");
