package com.szjm.controller.lsh.softwareupdate;
...
public class SoftwareUpdateController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("lsh/softwareupdate/softwareupdate_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("lsh/softwareupdate/softwareupdate_edit");
