package com.szjm.controller.lsh.goods;
...
public class GoodsController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception {
		...
		mv.setViewName("lsh/goods/goods_list");
	...
	public ModelAndView goAdd() throws Exception {
		...
		mv.setViewName("lsh/goods/goods_add");
	...
	public ModelAndView goEdit() throws Exception {
		...
		mv.setViewName("lsh/goods/goods_edit");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/editIndexPictures")
	public ModelAndView editIndexPictures() throws Exception {
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("lsh/goods/goods_index_pictures");
		mv.addObject("pd", pd);
		return mv;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/saveIndexPictures")
	public ModelAndView saveIndexPictures() throws Exception {
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		// 保存首页展示图
		goodsService.saveIndexPictures(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
