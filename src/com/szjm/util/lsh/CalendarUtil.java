...
public class CalendarUtil {
     ...
     * @author liu 2015-1-5
     */
    public static int getMonthDays(int lunarYeay, int month) throws Exception {
        if ((month > 31) || (month < 0)) {
     ...
     * @throws Exception
     */
    public static void checkLunarDate(int lunarYear, int lunarMonth, int lunarDay, boolean leapMonthFlag) throws Exception {
    ...
    public static String solarToLunar(String solarDate) throws Exception{
        ...
        lunarMonth = i;
        lunarDay = offset;
        return lunarYear+"年"+(leapMonthFlag&(lunarMonth==leapMonth)?"闰":"")+(lunarMonth<10?"0"+lunarMonth:lunarMonth)+"月"+(lunarDay<10?"0"+lunarDay:lunarDay)+"日";
    }
}
