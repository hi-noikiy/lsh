...
public class Const {
	...
	public static final String SESSION_APP_USER_ID = "SESSION_APP_USER_ID";	//APP用户编号
	public static final String SESSION_APP_USER_ROLE = "SESSION_APP_USER_ROLE";	//APP用户角色
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(lshapp)|(uploadFiles)|(plugins)).*";	//不对匹配该值的访问路径拦截（正则）
