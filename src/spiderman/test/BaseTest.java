...
public class BaseTest {
	...
	public void test44(){
		try {
			System.out.println(BirthdayUtil.getNextSolarBirthday("2016-02-29"));
			//System.out.println(BirthdayUtil.getNextSolarBirthday("1992-04-25"));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void test45(){
		try {
			String solar_birthday = "1980-04-03";//选择的新历生日
			System.out.println("新历生日"+solar_birthday);
			...
			String nextLunarBirthday = BirthdayUtil.getNextLunarBirthday(lunarBirthday);//下一次农历新历日期
	...
	public void test46(){
		try {
			System.out.println(CalendarUtil.getLeapMonth(2017));
			System.out.println(CalendarUtil.getLeapMonthDays(1991));/*
			System.out.println(CalendarUtil.lunarToSolar("20180530", false));
			System.out.println(CalendarUtil.lunarToSolar("19900506", true));
			System.out.println("************");
	...
	public void test47(){
		try {
			System.out.println(BirthdayUtil.getNextLunarBirthday("19920425"));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void test48(){
		try {
			AlipayInterfaceInvokeUtil.AlipayFundTransToaccountTransfer("201808171743", "ALIPAY_LOGONID", "13790445950", "0.1", "礼尚汇", "陈仕鹏", "提现");
		} catch (AlipayApiException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void test49(){
		...
		unifiedOrderSend.setOut_trade_no("201808181736");
		Double realPay = Double.valueOf("1") * 100;
		unifiedOrderSend.setTotal_fee(100);
		unifiedOrderSend.setSpbill_create_ip("127.0.0.1");
	...
	@Test
	public void test50(){
		WechatUser wechatUser=AppWechatInterfaceInvokeUtil.pullUserInformation("0019cYJe00C9nB1s0SKe0EFDJe09cYJv");
		System.out.println(wechatUser.getOpenid());
	}
	@Test
	public void test51(){
		CompanyPaySend companyPaySend=new CompanyPaySend();
		companyPaySend.setPartner_trade_no("201808231346");
		companyPaySend.setOpenid("oNR4O05s2u1CJ8x-WQfT2j39gOnM");
		companyPaySend.setCheck_name("NO_CHECK");
		companyPaySend.setAmount(100);
		companyPaySend.setDesc("企业付款测试之1");
		companyPaySend.setSpbill_create_ip("127.0.0.1");
