 ...
 *
 */
public class WechatUserResult extends BaseWechatResult {
	...
	private String tagid_list_tostring;
	...
	public String getTagid_list_tostring() {
		if(tagid_list!=null){
			return tagid_list.toString();
		}else{
			return null;
		}
	}
	public void setTagid_list_tostring(String tagid_list_tostring) {
		this.tagid_list_tostring = tagid_list_tostring;
	}
