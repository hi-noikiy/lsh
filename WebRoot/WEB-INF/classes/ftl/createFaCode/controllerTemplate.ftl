package com.szjm.controller.${packageName}.${objectNameLower};
...
import com.szjm.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.szjm.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
