		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="integrationrecord/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="INTEGRATIONRECORD_ID" id="INTEGRATIONRECORD_ID" value="${pd.INTEGRATIONRECORD_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">编号:</td>
								<td><input type="number" name="INTEGRATIONRECORD_ID" id="INTEGRATIONRECORD_ID" value="${pd.INTEGRATIONRECORD_ID}" maxlength="32" placeholder="这里输入编号" title="编号" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">类型:</td>
								<td><input type="number" name="RECORD_TYPE" id="RECORD_TYPE" value="${pd.RECORD_TYPE}" maxlength="32" placeholder="这里输入类型" title="类型" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">金额:</td>
								<td><input type="number" name="AMOUNT" id="AMOUNT" value="${pd.AMOUNT}" maxlength="32" placeholder="这里输入金额" title="金额" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="number" name="INCOME_REASON" id="INCOME_REASON" value="${pd.INCOME_REASON}" maxlength="32" placeholder="这里输入收入来源" title="收入来源" style="width:98%;"/></td>
							</tr>
							<tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		//保存
		function save(){
			if($("#INTEGRATIONRECORD_ID").val()==""){
				$("#INTEGRATIONRECORD_ID").tips({
					side:3,
		            msg:'请输入编号',
		            bg:'#AE81FF',
		            time:2
		        });
				$("#INTEGRATIONRECORD_ID").focus();
			return false;
			}
			if($("#RECORD_TYPE").val()==""){
				$("#RECORD_TYPE").tips({
