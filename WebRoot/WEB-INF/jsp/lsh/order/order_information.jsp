						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td>
									...
									<c:if test="${pd.PAY_WAY=='3'}">礼豆</c:if>
								</td>
							</tr>
							<tr>
								<td style="width:110px;text-align: right;padding-top: 13px;">支付状态:</td>
								<td >
									<c:if test="${pd.PAY_STATUS=='0'}">未支付</c:if>
									<c:if test="${pd.PAY_STATUS=='1'}">已支付</c:if>
								</td>
								<td></td>
								<td></td>
							</tr>
							...
							<tr>
								...
								<td style="width:110px;text-align: right;padding-top: 13px;">礼豆抵扣金额:</td>
