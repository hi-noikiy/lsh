...
<!-- 								<td style="padding-left:2px;"><input class="span10 date-picker" name="lastStart" id="lastStart"  value="" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:88px;" placeholder="开始日期" title="开始日期"/></td>
								...
								<td style="vertical-align:top;padding-left:2px;">
									<select class="chosen-select form-control" name="GOODS_POSITION" id="GOODS_POSITION" data-placeholder="请选择商品类型" style="vertical-align:top;width: 130px;">
										<option value="" <c:if test="${ '' ==pd.GOODS_POSITION}">selected="selected"</c:if>></option>
										<option value="">全部</option>
...
<%-- 								<c:if test="${QX.toExcel == 1 }"><td style="vertical-align:top;padding-left:2px;"><a class="btn btn-light btn-xs" onclick="toExcel();" title="导出到EXCEL"><i id="nav-search-icon" class="ace-icon fa fa-download bigger-110 nav-search-icon blue"></i></a></td></c:if> --%>
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'>
												...
												<c:if test="${var.IS_INDEX=='1'}">展示</c:if>
											</td>
											<td class='center'>
												<img alt="" src="<%=basePath%>uploadFiles/uploadImgs/${var.PATH}" style="height: 50px;width: 50px;">
											</td>
											<td class='center'>
												<img alt="" src="<%=basePath%>uploadFiles/uploadImgs/${var.PATHS}" style="height: 50px;width: 50px;">
											</td>
											...
											<%-- <td class='center'>${var.GOODS_DETAILS}</td> --%>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<a class="btn btn-xs btn-success" style="margin-right:5px;" title="编辑首页展示图" onclick="editIndexPictures('${var.GOODS_ID}');">编辑首页展示图</a>
													<a class="btn btn-xs btn-success" style="margin-right:5px;" title="编辑轮播图" onclick="editPictures('${var.GOODS_ID}');">编辑轮播图</a>
													<a class="btn btn-xs btn-success" style="margin-right:5px;" title="编辑SKU" onclick="editSpec('${var.GOODS_ID}');">编辑SKU</a>
													</c:if>
													<c:if test="${QX.del == 1 }">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															...
															<li>
																<a style="cursor:pointer;" onclick="editPictures('${var.GOODS_ID}');" class="tooltip-success" data-rel="tooltip" title="编辑轮播图">
																	<span class="green">
																		<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																	</span>
																</a>
															...
															<li>
																<a style="cursor:pointer;" onclick="editIndexPictures('${var.GOODS_ID}');" class="tooltip-success" data-rel="tooltip" title="编辑首页展示图">
																	<span class="green">
																		<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																	</span>
																</a>
															...
															<li>
																<a style="cursor:pointer;" onclick="editSpec('${var.GOODS_ID}');" class="tooltip-success" data-rel="tooltip" title="编辑SKU">
																	<span class="green">
																		<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																	</span>
																</a>
	...
	<script type="text/javascript">
		...
		function editPictures(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑商品轮播图";
			 diag.URL = '<%=basePath%>goodspicture/list.do?GOODS_ID='+Id;
			 diag.Width = 850;
			 diag.Height = 555;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
			...
			//编辑首页展示图
		function editIndexPictures(Id){
			 top.jzts();
			 var diag = new top.Dialog();
			 diag.Drag=true;
			 diag.Title ="编辑首页展示图";
			 diag.URL = '<%=basePath%>goods/editIndexPictures.do?GOODS_ID='+Id;
			 diag.Width = 850;
			 diag.Height = 155;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
		...
		function editSpec(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑商品规格";
			 diag.URL = '<%=basePath%>goodssku/list.do?GOODS_ID='+Id;
			 diag.Width = 850;
			 diag.Height = 555;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
