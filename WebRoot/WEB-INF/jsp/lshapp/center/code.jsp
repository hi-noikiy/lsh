...
<body style="background:url(static/lshapp/images/center/Recommendationcode-hdpi.jpg) no-repeat; background-size: cover;width: 100%; ">
...
<div class="con" style="width: 100%;max-height: 300px;">
   <div class="affiliate-cont-box" style="background-color: white;position:relative;max-width: 100%;max-height: 100%; ">
		    <div id="dialog" style="display: block;position:fixed; bottom:130px;width: 205px;height: 235px;padding: 10px;padding-bottom:5px;padding-right: 10px;text-align: center;left: 52%;">
...
<script>
jQuery('#dialog').qrcode({width: 185,height: 185,text: "${url}"});
</script>
