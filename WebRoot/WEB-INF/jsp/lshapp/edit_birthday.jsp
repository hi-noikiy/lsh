...
<form action="<%=basePath%>lshapp/userbrithday/editUserBirthday.do" name="Form" id="Form" method="post">
	...
	<div class="s-user-top onclik-nick_name" style="background:#fff;">
		<div class="dis-box s-xian-box s-user-top-1">
			<h3 style="width: 60px;font-size: 16px; margin-top: -2px;">姓名</h3>
	...
	<div class="s-user-top onclik-nick_name" style="background:#fff;">
		<div class="dis-box s-xian-box s-user-top-1">
			<h3 style="width: 60px;font-size: 16px;margin-top: -2px;" >生日</h3>
			<input style="border: 0;font-size:1.4rem;width:280px;" type="text" placeholder="请选择生日" value="新历:${pd.SOLAR_BIRTHDAY}  农历:${pd.LUNAR_CALENDAR }" class="input" id="SHENGRI" name="SHENGRI" readonly="readonly" onclick="showDates();">
	...
	<div class="s-user-top onclik-nick_name" style="background:#fff;display: none" id="zidingyi">
		<div class="dis-box s-xian-box s-user-top-1">
			<h3 style="width: 80px;font-size: 16px;">关系名称</h3>
