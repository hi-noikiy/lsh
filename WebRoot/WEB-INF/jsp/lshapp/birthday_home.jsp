...
<link rel="stylesheet" href="static/lshapp/css/birthday1.css"/>
...
<div id="wrapper" style="margin-bottom: 4.0rem;">

		<!-- header 开始 -->
    	<div >
    	  <div class="zixuntext" style="font-size:18px;padding: 5px;">生日</div>
		<hr style="height:1px;border:none;border-top:3px solid #f5f5f5;"></hr>
</div>
<!-- header 结束 -->
	<div class="div-bor" >

		<div class="user1" onclick="addBirthday()">
				<img src="static/lshapp/images/user-hdpi.png" style="width:25px;height:25px;float:left;margin-top: 5px;margin-left: 11px;"></img>
				<div style="width:75px;float:right;margin-top:8px;" class="addusers" >添加生日</div>
		</div>

		<div  class="user2"  onclick="addCommemorate()" >
			<img src="static/lshapp/images/Anniversaries.png" style="width:25px;height:25px;float:left;margin-top: 5px;margin-left: 11px;"></img>
			<div style="width:75px;float:right;margin-top:8px;">添加纪念日</div>
		</div>
	</div>
	<div style="height: 40px;width:65px;padding-top: 2em;padding-left: 1.1em;">
		<img src="static/lshapp/images/user11-hdpi.png" style="width:20px;height:20px;">
		<div style="font-size:14px;width: 30px;float: right;margin-top: -18px;color:#9d9d9d">用户</div>
	</div>
	<div class="Newsinfo">
		 <ul class="tabslider">
			 <c:forEach items="${varList}" var="var" varStatus="vs">
			<li onclick="birthdayDetail('${var.BIRTHDAY_ID}')" id="delLi">
				<div style="width:40px;height40px;">
				<c:if test="${var.PATH != null}"><img src="<%=basePath%>uploadFiles/uploadImgs/${var.PATH}"></img></c:if>
				<c:if test="${var.PATH == null}"><img src="static/lshapp/images/default_head.png"></img></c:if>
				</div>
				<div style="width:80px;height:48px;margin-top:-60px;margin-left:60px;">
					<div style="font-size:14px;">${var.NAME}</div>
					<c:if test="${var.RELATIONSHIP == '家人' }">
					<img style="width: 15px;height: 15px;float: right;margin-top:-16px;" src="static/lshapp/images/Family-hdpi.png"></img>
					</c:if>
					<c:if test="${var.RELATIONSHIP == '朋友' }">
					<img style="width: 15px;height: 15px;float: right;margin-top:-16px;" src="static/lshapp/images/Friend-hdpi.png"></img>
					</c:if>
					<p style="font-size:13px;margin-top:10px;">${var.SOLAR_BIRTHDAY }</p>
				</div>
				<div style="width:120px;height:40px;margin-top:-43px;margin-right:0px;float:right">
					<p style="margin-top: -10px;">sdfasf</p>
					<p style="font-size:13px;margin-top:27px;color:#9d9d9d">${var.PHONE_NUMBER }</p>
					<img style="width: 8px;height: 13px;float: right;margin-top:-16px;" src="static/lshapp/images/right_arrow.png"></img>
				</div>

			</li>
			</c:forEach>
			<!-- li  id="delLi" style="border:1px red solid;">
				<div style="width:60px;height:60px;border:1px red solid;">
				
				<img src="static/lshapp/images/default_head.png"></img>
				</div>
				<div style="width:120px;height:30px;border:1px yellow solid;float: left">
					<div style="font-size:14px;border:1px red solid;float: left;">了解要求</div>
				...
				<div style="width:120px;height:40px;margin-top:-43px;margin-right:0px;float:right">
					...
					<p style="font-size:13px;margin-top:27px;color:#9d9d9d">15899775544</p>
					<img style="width: 8px;height: 13px;float: right;margin-top:-16px;" src="static/lshapp/images/right_arrow.png"></img>
				</div>
		...
		<!-- <div style="width: 100%;height: 60px;border:1px red solid;margin-top: 10px;">
		<div style="width: 100%;height: 50px;border:1px red solid;">
			<div style="width: 50px; border:1px red solid;">
			<img src="static/lshapp/images/default_head.png" ></img>
			</div>
		</div>
		</div> -->
    ...
    <hr style="margin-top:5px;height:3px;border:none;border-top:5px solid #f5f5f5;"></hr>

    <div style="height: 25px;width:85px;padding-top: 0.5em;padding-left: 1.1em;">
		<img src="static/lshapp/images/Anniversaries_of_important_events.png" style="width:20px;height:20px"></img>
		<div style="font-size:14px;width: 45px;float: right;margin-top: -18px;color:#9d9d9d">纪念日</div>

	</div>
    <div class="Newsinfo">
		<ul class="tabslider">
			<c:forEach items="${memoList}" var="var" varStatus="vs">
			<li onclick="goEditMemorialday('${var.MEMORIALDAY_ID}')">
				<div style="width:40px;height:40px;">

				</div>
				<div style="height:40px;margin-top:-40px;">
					<h1 style="font-size:13px;">${var.NAME}</h1>
					<p style="font-size:13px;margin-top:5px;color:#9d9d9d">纪念日：${var.COMMEMORATE_DATE }</p>
				</div>
				<div style="width:60px;height:40px;margin-top:-50px;float:right">
					<p style="font-size:18px;margin-top:6px;color:#535353;font-weight:bold">${var.DAYS }
					<img src="static/lshapp/images/distance-hdpi.png" style="width:12px;height:15px;float: right;margin-top:6px"></img>
					</p>
				</div>
	...
	<footer class="footer-nav dis-box">
	    <a href="<%=basePath%>lshapp/userbrithday/list.do" class="box-flex nav-list active">
	        <i class="nav-box i-home1" style="background: url('<%=basePath%>static/lshapp/images/Birthday-Fill-hdpi.png') no-repeat;background-size:100% 100%;"></i><span>生日</span>
	    </a>
	...
	<%-- <footer class="footer-nav dis-box">
    <a href="javascript:parent.window.switchpage(1);" class="box-flex nav-list active">
        <i class="nav-box i-home1" style="background: url('<%=basePath%>static/lshapp/images/Birthday-Fill-hdpi.png') no-repeat;background-size:100% 100%;"></i><span>生日</span>
    </a>
...
<script type="text/javascript">
	...
	function addBirthday(){
		window.location.href='<%=basePath%>lshapp/userbrithday/goAddbrithday';
		//window.event.returnValue=false;
	}
	// 修改好友生日
	function birthdayDetail(Id){
		window.location.href='<%=basePath%>lshapp/userbrithday/birthdayDetail.do?BIRTHDAY_ID='+Id;
		//window.event.returnValue=false;
	}

	function addCommemorate(){
		window.location.href='<%=basePath%>/lshapp/memorialday/goMemorialday.do';
		//window.event.returnValue=false;
	}
	// 修改好友生日
	function goEditMemorialday(Id){
		window.location.href='<%=basePath%>lshapp/memorialday/goEditMemorialday.do?MEMORIALDAY_ID='+Id;
		//window.event.returnValue=false;
	}
