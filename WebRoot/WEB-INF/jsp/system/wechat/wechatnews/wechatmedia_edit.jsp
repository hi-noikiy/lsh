		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="wechatnews/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
						<input type="hidden" name="WECHAT_MEDIA_ID" id="WECHATMEDIA_ID" value="${pd.WECHATMEDIA_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">媒体类型:</td>
								<td><input type="text" value="news" readonly="readonly"></td>
							</tr>
							<tr>
