									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											<td class='center' style="width: 30px;">
												<label><input type='checkbox' name='ids' class="ace" value="${var.TEXTMSG_ID}" /><span class="lbl"></span></label>
											</td>
											...
											<td style="width: 100px;" class="center">
												...
												<c:if test="${QX.edit == 1 }">
												<a style="cursor:pointer;" class="green" onclick="edit('${var.TEXTMSG_ID}');" title="编辑">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>
												</c:if>
												<c:if test="${QX.del == 1 }">
												<a style="cursor:pointer;" class="red" onclick="del('${var.TEXTMSG_ID}');" title="删除">
